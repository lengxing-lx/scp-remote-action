...
test('check file/dir exist', () => {
  expect(utils.checkLocalFileOrDirExist("/Users/a/opensource/scp-remote-action")).toEqual(true)
  expect(utils.checkLocalFileOrDirExist("/Users/a/opensource/scp-remote-action/README.md")).toEqual(true)
  expect(utils.checkLocalFileOrDirExist("/Users/a/opensource/scp-remote-actionssss")).toEqual(false)
})
